...
class RDN(nn.Module):
    def __init__(self):
        ...
        self.SFE1 = nn.Conv2d(3, self.G0, kernel_size=kernel_size, padding=kernel_size>>1, stride=1)
        ...
        self.outnet = nn.Sequential(
                ...
                nn.Conv2d(self.G, self.G,kernel_size = kernel_size,padding =kernel_size>>1,stride=1),
