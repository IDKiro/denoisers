...
class IndexedMatmulEfficient(torch.autograd.Function):
    @staticmethod
...
def indexed_matmul_efficient(x,y,I, chunk_size=256):
    return IndexedMatmulEfficient.apply(x,y,I,chunk_size)
