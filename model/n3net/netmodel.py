...
class Network(nn.Module):
    ...
    """
    def __init__(self, nplanes_in=3, nplanes_out=3, nplanes_interm=3, nblocks=3, 
                    block_opt={'features':64, 'kernel':3, 'depth':6, 'residual':1, 'bn':0}, 
                    nl_opt={'k':7}, residual=False):
        r"""
        :param nplanes_in: number of input features
